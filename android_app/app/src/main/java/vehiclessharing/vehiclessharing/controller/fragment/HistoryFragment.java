...
public class HistoryFragment extends Fragment implements GetHistoryData.HistoryHikerCallback,SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  txtTest.setText(userType);
        GetHistoryData.getInstance(this).getHistoryHiker(MainActivity.sessionId, userType);
